    ...
    const handleSubmit = async (event) => 
    {
        ...
        else if (cardComplete) 
        {
            ...
            else
            {
                ...
                const res = await fetch(`${REACT_APP_API_URL}/v1/payments/card`, requestOptions);
                if (res.status === 200)
                {
                    console.log("(2) Change Succeeded");
                    setSuccess(true);
                }
                else
                {
    ...
    if (success === true && !processing)
    {
        return (
            <div className='checkout-result body'>
                ...
                <span className='checkout-result sub-header'>Your card details have successfully been changed.<br/><a href="/account-settings">Click here</a> to go to your account settings.</span>
            </div>
        )
    }
        ...
        return (
            <div className='checkout-result body'>
                ...
                <span className='checkout-result sub-header'>
                    We were unable to change your card details unsuccessful. Please <a href={"/account-settings/card" + window.location.search}>try again.</a><br/>
    ...
    render()
    {
        ...
        if (isLoaded)
        {
            return (
                ...
                <div className="home body checkout modify">
...
export default withRouter(ModifyCard);
