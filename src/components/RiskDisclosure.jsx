            ...
            <div className="home body">
                ...
                <section className="general-info body">
                    <div className="general-info item legal">
                        ...
                        <p><strong>Risk Disclosure:</strong> AlgoWolf is a software development company and does not provide investment or brokerage services. Nothing in this website should be construed as a solicitation to trade in the Foreign Exchange market. BEFORE YOU MAKE ANY DECISION IN RELATION TO USING OUR SERVICES YOU SHOULD SEEK INDEPENDENT PROFESSIONAL ADVICE. </p>
