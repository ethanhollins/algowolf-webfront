                ...
                <div className="container">
                    ...
                    <div className="row footer-bottom">
                        <div className="col-md-12">
                            ...
                            <p>AlgoWolf is a software development company and does not provide investment or brokerage services. Nothing in this website should be construed as a solicitation to trade in any financial market. AlgoWolf is a trading name of Tymraft Pty Ltd, ACN: 006 268 131.</p>
