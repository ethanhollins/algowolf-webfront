                ...
                <section className="general-info body">
                    <div className="general-info item legal">
                        ...
                        <ul>
                            ...
                            <li>We reserve the right to refuse service to anyone at any time for any reason. This includes access to our website and algorithmic software.</li>
                        </ul>
                        ...
                        <p><em>After</em> the 14-day refund period, refunds or account credits will not be issued for situations as follows:</p>
                        <ul>
                        ...
                        <ul>
                            <li>The transactional fee charged by our payment provider to process the payment will not be returned. This is the fee the payment provider is charged by the banks to process the payment.</li>
                        </ul>
